          ...
          <div class="card-body p-md-10">
            <div class="row justify-content-center">
              <div class="col-md-9 col-lg-8 col-xl-10 order-5 order-lg-9">
                ...
                <p class="text-center h2 fw-bold mb-5 mx-3 mx-md-4 mt-2">Sign In</p>

                <form action="loginAction.php" class="mx-1 mx-md-4" method="POST">
                  ...
                  <div class="d-flex justify-content-center mx-4 mb-2 mb-lg-4">
                    <button type="submit" name="button" class="btn btn-primary btn-lg">Masuk</button>
                  </div>
