            ...
            <li class="nav-item">
                ...
                <div id="userMenu" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="../adminpage/user.php">Daftar User</a>
                    </div>
                </div>
            </li>
            ...
            <li class="nav-item">
                ...
                <div id="reservasi" class="collapse" aria-labelledby="headingReservasi" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="../adminpage/diterima.php">Pengajuan Di Terima</a>
                        <a class="collapse-item" href="../adminpage/ditolak.php">Pengajuan Di Tolak</a>
                        <a class="collapse-item" href="../adminpage/semua_pengajuan.php">Riwayat Pengajuan</a>
                    </div>
                </div>
            </li>
